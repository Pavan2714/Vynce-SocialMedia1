      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <h3
              className="font-semibold text-white text-lg truncate cursor-pointer hover:text-pink-400 transition-colors"
              onClick={() => navigate(`/profile/${user._id}`)}
            >
              {user.full_name}
            </h3>
        ...
        <button
          ...
          className={`flex-shrink-0 px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 font-medium transition-all duration-300 active:scale-95 whitespace-nowrap ${
            isFollowing
